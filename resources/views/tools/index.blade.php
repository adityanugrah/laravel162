...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
		...
		<a href="/download/Template Tools.ods" class="btn btn-primary">Download Template </a>
		<table>
			<tr>				
				<form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 20px;" action="{{ URL::to('importTools') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
